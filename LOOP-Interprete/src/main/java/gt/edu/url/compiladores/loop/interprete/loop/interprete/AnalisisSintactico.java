  ...
  public final java_cup.runtime.Symbol CUP$AnalisisSintactico$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalisisSintactico$act_num)
		...
		Integer n = (Integer)((java_cup.runtime.Symbol) CUP$AnalisisSintactico$stack.elementAt(CUP$AnalisisSintactico$top-2)).value;
		...
		Integer s = (Integer)((java_cup.runtime.Symbol) CUP$AnalisisSintactico$stack.peek()).value;
            ...
            Integer resultado=s + n;
            System.out.println("SYN: "+resultado);
            RESULT=resultado;
        
              CUP$AnalisisSintactico$result = parser.getSymbolFactory().newSymbol("S",0, ((java_cup.runtime.Symbol)CUP$AnalisisSintactico$stack.elementAt(CUP$AnalisisSintactico$top-2)), ((java_cup.runtime.Symbol)CUP$AnalisisSintactico$stack.peek()), RESULT);
            }
		...
		Integer n = (Integer)((java_cup.runtime.Symbol) CUP$AnalisisSintactico$stack.peek()).value;
		 
            System.out.println("SYN: "+n);
            RESULT=n;
