...
comini=[\u002F][\u002A]
comfin=[\u002A][\u002F]
comentarios = {comini}([\u0020]*|[\u0020]|{num}|{ace}|{ace}*|{letrasma}|{letrasmi}|{noace}|{diago}|{simbolos}|{simbolos})*
comentariose = "**"([\u0020]+|[\u0020]|{num}|{ace}|{ace}*|{letrasma}|{letrasmi}|{noace}|{diago}|{simbolos}|{simbolos})*
retu="devolver "[\u0020]*
nocome=[\u002F]
enter = "-"?[0-9]+
real = "-"?[0-9]+("." [0-9]+)?
